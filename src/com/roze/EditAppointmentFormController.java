...
public class EditAppointmentFormController implements Initializable {
    ...
    public void displayFields() {
        editApp_appointmentID.setText(com.roze.Data.temp_appID);
        editApp_fullName.setText(com.roze.Data.temp_appName);
        editApp_gender.getSelectionModel().select(com.roze.Data.temp_appGender);
        editApp_mobileNumber.setText(com.roze.Data.temp_appMobileNumber);
        editApp_address.setText(com.roze.Data.temp_appAddress);
        editApp_description.setText(com.roze.Data.temp_appDescription);
        editApp_diagnosis.setText(com.roze.Data.temp_appDiagnosis);
        editApp_treatment.setText(com.roze.Data.temp_appTreatment);
        editApp_doctor.getSelectionModel().select(com.roze.Data.temp_appDoctor);
        editApp_specialized.getSelectionModel().select(com.roze.Data.temp_appSpecialized);
        editApp_status.getSelectionModel().select(com.roze.Data.temp_appStatus);
    }
