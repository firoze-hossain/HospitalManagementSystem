...
public class EditPatientFormController implements Initializable {
    ...
    public void setField() {
        edit_patientID.setText(String.valueOf(com.roze.Data.temp_PatientID));
        edit_name.setText(com.roze.Data.temp_name);
        edit_gender.getSelectionModel().select(com.roze.Data.temp_gender);
        edit_contactNumber.setText(String.valueOf(com.roze.Data.temp_number));
        edit_address.setText(com.roze.Data.temp_address);
        edit_status.getSelectionModel().select(com.roze.Data.temp_status);
    }
