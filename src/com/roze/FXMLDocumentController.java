...
public class FXMLDocumentController implements Initializable {
    ...
    public void loginAccount() {
        ...
        if (login_username.getText().isEmpty()
            ...
            try {
                ...
                if (result.next()) {
                    // TO GET THE USERNAME
                    com.roze.Data.admin_username = login_username.getText();
                    com.roze.Data.admin_id = Integer.parseInt(result.getString("admin_id"));
    ...
    public void userList() {
        ...
        for (String data : com.roze.Users.user) {
            listU.add(data);
        }
